...
CREATE TABLE "problem" (
	...
	"status" "ProblemStatus" DEFAULT 'DRAFT' NOT NULL,
...
CREATE TABLE "submission" (
	...
	"failed_testcases" integer DEFAULT 0 NOT NULL,
	"time_taken" integer DEFAULT 0 NOT NULL,
	"memory_taken" integer DEFAULT 0 NOT NULL,
	"created_at" timestamp(3) DEFAULT (now() AT TIME ZONE 'UTC'::text) NOT NULL,
	"updated_at" timestamp(3) DEFAULT (now() AT TIME ZONE 'UTC'::text) NOT NULL
);
--> statement-breakpoint
...
ALTER TABLE "hint" ADD CONSTRAINT "hint_problem_id_problem_id_fk" FOREIGN KEY ("problem_id") REFERENCES "public"."problem"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "problem_tag" ADD CONSTRAINT "problem_tag_problem_id_problem_id_fk" FOREIGN KEY ("problem_id") REFERENCES "public"."problem"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "problem_tag" ADD CONSTRAINT "problem_tag_tag_id_tag_id_fk" FOREIGN KEY ("tag_id") REFERENCES "public"."tag"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
CREATE INDEX "hints_problem_id_idx" ON "hint" USING btree ("problem_id");--> statement-breakpoint
