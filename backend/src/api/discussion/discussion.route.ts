...
// import { createDiscussion, getDiscussions, likeDiscussion, createComment, dislikeDiscussion, deleteDiscussion } from './discussion.controller.js';
...
// router.get('/:discussionId/like', verifyJWT, likeDiscussion);
