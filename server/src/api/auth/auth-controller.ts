...
// import { handleGoogleOauth } from './auth-service';
...
//     const tokenResponse : any = { accessToken: response.accessToken, refreshToken: response.refreshToken };

//     const responseData = setAuthCookies(res, tokenResponse, origin);
